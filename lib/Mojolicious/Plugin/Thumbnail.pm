...
Andrey Gatitskiy <gatitskiy@cpan.org>

=over 4
 
=item * Github
 
L<http://github.com/gatitskiy/mojolicious-plugin-thumbnail>
 
=item * RT: CPAN's request tracker
 
L<http://rt.cpan.org/NoAuth/Bugs.htMail?Dist=Mojolicious-Plugin-Thumbnail>
 
=item * Search CPAN
 
L<http://search.cpan.org/dist/Mojolicious-Plugin-Thumbnail>
